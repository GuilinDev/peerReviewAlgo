...
## General BQs
### Self Introduction
Hi My name is XXX. I am currently working at XX company as a Software Engineer and have been working here for almost one year. Over here my responsibilities are using my skills to develop big data platform, this platform process personal raw data to generate profiles for business customers. Particualarly, I do grooming on these data and move these data among pipelines. And my daily work is conducting software development, architecture design and hotfix trouble shooting.
